...
// Borramos la carpeta: rm -rf midasTop2/
// clonamos lo de github a la nueva carpeta
// git clone https://github.com/totogarcia/midasTop2.git
// cd midasTop2 
// npm install
// pm2 start index.js
...
var ApiRobot = (function () {
    function ApiRobot(_servicio1, _favoritoService) {
        ...
        this.mercadoAcciones = [
            ...
            //{icono: 'ios-star-outline', nombre: 'Ranger Oil Corp', ticker: 'ROCC.US'},{icono: 'ios-star-outline', nombre: 'Destination XL Group', ticker: 'DXLG.US'},{icono: 'ios-star-outline', nombre: 'Kura Sushi USA Inc Cl A', ticker: 'KRUS.US'},{icono: 'ios-star-outline', nombre: 'Lantheus Holdings', ticker: 'LNTH.US'},{icono: 'ios-star-outline', nombre: 'Obsidian Energy Ltd', ticker: 'OBE.US'},{icono: 'ios-star-outline', nombre: 'Merrimack Pharmaceuticals Inc', ticker: 'MACK.US'},{icono: 'ios-star-outline', nombre: 'CVD Equipment Corp', ticker: 'CVV.US'},{icono: 'ios-star-outline', nombre: 'Impinj Inc', ticker: 'PI.US'},{icono: 'ios-star-outline', nombre: 'Cvr Partners LP', ticker: 'UAN.US'},{icono: 'ios-star-outline', nombre: 'Nextier Oilfield Solutions Inc', ticker: 'NEX.US'},{icono: 'ios-star-outline', nombre: 'Targa Resources', ticker: 'TRGP.US'},{icono: 'ios-star-outline', nombre: 'Murphy Oil Corp', ticker: 'MUR.US'},{icono: 'ios-star-outline', nombre: 'Hallador Energy Company', ticker: 'HNRG.US'},{icono: 'ios-star-outline', nombre: 'On Semiconductor', ticker: 'ON.US'},{icono: 'ios-star-outline', nombre: 'Enerplus Corp', ticker: 'ERF.US'},{icono: 'ios-star-outline', nombre: 'Devon Energy Corp', ticker: 'DVN.US'},{icono: 'ios-star-outline', nombre: 'Kosmos Energy Ltd', ticker: 'KOS.US'},{icono: 'ios-star-outline', nombre: 'Target Hospitality Corp', ticker: 'TH.US'},{icono: 'ios-star-outline', nombre: 'Atkore Inc', ticker: 'ATKR.US'},{icono: 'ios-star-outline', nombre: 'Climb Global Solutions Inc', ticker: 'CLMB.US'},{icono: 'ios-star-outline', nombre: 'Prothena Corp', ticker: 'PRTA.US'},{icono: 'ios-star-outline', nombre: 'Amplify Energy Corp', ticker: 'AMPY.US'},{icono: 'ios-star-outline', nombre: 'L.S. Starrett Company', ticker: 'SCX.US'},{icono: 'ios-star-outline', nombre: 'Builders Firstsource', ticker: 'BLDR.US'},{icono: 'ios-star-outline', nombre: 'Ryerson Holding Corp', ticker: 'RYI.US'},{icono: 'ios-star-outline', nombre: 'Wesco International', ticker: 'WCC.US'},{icono: 'ios-star-outline', nombre: 'Euroseas Ltd', ticker: 'ESEA.US'},{icono: 'ios-star-outline', nombre: 'R C M Tech Inc', ticker: 'RCMT.US'},{icono: 'ios-star-outline', nombre: 'Civitas Resources Inc', ticker: 'CIVI.US'},{icono: 'ios-star-outline', nombre: 'Nvidia Corp', ticker: 'NVDA.US'},{icono: 'ios-star-outline', nombre: 'Calumet Specialty Pr', ticker: 'CLMT.US'},{icono: 'ios-star-outline', nombre: 'Axcelis Tech Inc', ticker: 'ACLS.US'},{icono: 'ios-star-outline', nombre: 'Marathon Digital Hldgs Inc', ticker: 'MARA.US'},{icono: 'ios-star-outline', nombre: 'Riot Platforms Inc', ticker: 'RIOT.US'},{icono: 'ios-star-outline', nombre: 'Bluelinx Holdings Inc', ticker: 'BXC.US'},{icono: 'ios-star-outline', nombre: 'Dicks Sporting Goods Inc', ticker: 'DKS.US'},{icono: 'ios-star-outline', nombre: 'Atlas Lithium Corp', ticker: 'ATLX.US'},{icono: 'ios-star-outline', nombre: 'Perion Network Ltd', ticker: 'PERI.US'},{icono: 'ios-star-outline', nombre: 'CPI Card Group', ticker: 'PMTS.US'},{icono: 'ios-star-outline', nombre: 'Extreme Networks', ticker: 'EXTR.US'},{icono: 'ios-star-outline', nombre: 'Lattice Semicond', ticker: 'LSCC.US'},{icono: 'ios-star-outline', nombre: 'Peabody Energy Corp', ticker: 'BTU.US'},{icono: 'ios-star-outline', nombre: 'Build-A-Bear Workshop', ticker: 'BBW.US'},{icono: 'ios-star-outline', nombre: 'Shockwave Medical Inc', ticker: 'SWAV.US'},{icono: 'ios-star-outline', nombre: '374Water Inc', ticker: 'SCWO.US'},{icono: 'ios-star-outline', nombre: 'E.L.F. Beauty Inc', ticker: 'ELF.US'},{icono: 'ios-star-outline', nombre: 'Tidewater Inc', ticker: 'TDW.US'},{icono: 'ios-star-outline', nombre: 'Teekay Tankers Ltd', ticker: 'TNK.US'},{icono: 'ios-star-outline', nombre: 'Vista Energy S.A.B. DE C.V. ADR', ticker: 'VIST.US'},{icono: 'ios-star-outline', nombre: 'Intest Corp', ticker: 'INTT.US'},{icono: 'ios-star-outline', nombre: 'Olympic Steel Inc', ticker: 'ZEUS.US'},{icono: 'ios-star-outline', nombre: 'Nucor Corp', ticker: 'NUE.US'},{icono: 'ios-star-outline', nombre: 'Hovnanian Enterprises Inc', ticker: 'HOV.US'},{icono: 'ios-star-outline', nombre: 'Flex Lng Ltd', ticker: 'FLNG.US'},{icono: 'ios-star-outline', nombre: 'Iveric Bio Inc', ticker: 'ISEE.US'},{icono: 'ios-star-outline', nombre: 'Allegro Microsystems Inc', ticker: 'ALGM.US'},{icono: 'ios-star-outline', nombre: 'Moonlake Immunotherapeutics', ticker: 'MLTX.US'},{icono: 'ios-star-outline', nombre: 'Birks Group Inc', ticker: 'BGI.US'},{icono: 'ios-star-outline', nombre: 'Aehr Test Systems', ticker: 'AEHR.US'},{icono: 'ios-star-outline', nombre: 'Travelcenters of America Llc', ticker: 'TA.US'},{icono: 'ios-star-outline', nombre: 'Precision Drilling Corp', ticker: 'PDS.US'},{icono: 'ios-star-outline', nombre: 'Verona Pharma Plc ADR', ticker: 'VRNA.US'},{icono: 'ios-star-outline', nombre: 'Matador Resources Company', ticker: 'MTDR.US'},{icono: 'ios-star-outline', nombre: 'Dillard', ticker: 'DDS.US'},{icono: 'ios-star-outline', nombre: 'Frontline Plc', ticker: 'FRO.US'},{icono: 'ios-star-outline', nombre: 'Transmedics Group Inc', ticker: 'TMDX.US'},{icono: 'ios-star-outline', nombre: 'Silverbow Resources Inc', ticker: 'SBOW.US'},{icono: 'ios-star-outline', nombre: 'Lsb Industries Inc', ticker: 'LXU.US'},{icono: 'ios-star-outline', nombre: 'Innodata Inc', ticker: 'INOD.US'},{icono: 'ios-star-outline', nombre: 'Richardson Electrncs', ticker: 'RELL.US'},{icono: 'ios-star-outline', nombre: 'Lightwave Logic Inc', ticker: 'LWLG.US'},{icono: 'ios-star-outline', nombre: 'Vertex Energy', ticker: 'VTNR.US'},{icono: 'ios-star-outline', nombre: 'Tecnoglass Inc', ticker: 'TGLS.US'},{icono: 'ios-star-outline', nombre: 'Permian Basin Royalty Trust', ticker: 'PBT.US'},{icono: 'ios-star-outline', nombre: 'Marathon Oil Corp', ticker: 'MRO.US'},{icono: 'ios-star-outline', nombre: 'Veritiv Corp', ticker: 'VRTV.US'},{icono: 'ios-star-outline', nombre: 'Nine Energy Service Inc', ticker: 'NINE.US'},{icono: 'ios-star-outline', nombre: 'Avis Budget Group', ticker: 'CAR.US'},{icono: 'ios-star-outline', nombre: 'MYR Group Inc', ticker: 'MYRG.US'},{icono: 'ios-star-outline', nombre: 'Permian Resources Corp', ticker: 'PR.US'},{icono: 'ios-star-outline', nombre: 'Cenovus Energy Inc', ticker: 'CVE.US'},{icono: 'ios-star-outline', nombre: 'Marathon Petroleum Corp', ticker: 'MPC.US'},{icono: 'ios-star-outline', nombre: 'Hudson Tech Inc', ticker: 'HDSN.US'},{icono: 'ios-star-outline', nombre: 'Antero Resources Corp', ticker: 'AR.US'},{icono: 'ios-star-outline', nombre: 'Borr Drilling Ltd', ticker: 'BORR.US'},{icono: 'ios-star-outline', nombre: 'San Juan Basin Royalty Trust', ticker: 'SJT.US'},{icono: 'ios-star-oustline', nombre: 'Enlink Midstream Llc', ticker: 'ENLC.US'},{icono: 'ios-star-outline', nombre: 'Quanta Services', ticker: 'PWR.US'},{icono: 'ios-star-outline', nombre: 'Natural Resource Partners LP', ticker: 'NRP.US'},{icono: 'ios-star-outline', nombre: 'J. Jill Inc', ticker: 'JILL.US'},{icono: 'ios-star-outline', nombre: 'Sandridge Energy Inc', ticker: 'SD.US'},{icono: 'ios-star-outline', nombre: 'Range Resources Corp', ticker: 'RRC.US'},
            // las que metemos del parseo
            { icono: 'ios-star-outline', nombre: 'Weatherford International Plc', ticker: 'WFRD.US' },
            { icono: 'ios-star-outline', nombre: 'Modine Manufacturing', ticker: 'MOD.US' },
            // Ahora las demas
            { icono: 'ios-star-outline', nombre: 'Alteryx', ticker: 'AYX.US' },
            { icono: 'ios-star-outline', nombre: '3m Company', ticker: 'MMM.US' },
            { icono: 'ios-star-outline', nombre: 'Abiomed Inc.', ticker: 'ABMD.US' },
            { icono: 'ios-star-outline', nombre: 'Liberty Tripadv', ticker: 'LTRPA.US' },
            { icono: 'ios-star-outline', nombre: '51Job', ticker: 'JOBS.US' },
            { icono: 'ios-star-outline', nombre: 'Acorn International', ticker: 'ATV.US' },
            ...
            { icono: 'ios-star-outline', nombre: 'Flex LNG', ticker: 'FLNG.US' },
            ...
            { icono: 'ios-star-outline', nombre: 'Cambium Learning', ticker: 'ABCD.US' },
            ...
            { icono: 'ios-star-outline', nombre: 'Autohome', ticker: 'ATHM.US' },
            { icono: 'ios-star-outline', nombre: 'Mazor Robotics', ticker: 'MZOR.US' },
            { icono: 'ios-star-outline', nombre: 'G1 Therapeutics', ticker: 'GTHX.US' },
            { icono: 'ios-star-outline', nombre: 'Amag Pharmaceuticals', ticker: 'AMAG.US' },
            { icono: 'ios-star-outline', nombre: 'Lonestar Resources', ticker: 'LONE.US' },
            { icono: 'ios-star-outline', nombre: 'Sharpspring', ticker: 'SHSP.US' },
            { icono: 'ios-star-outline', nombre: 'Ultragenyx Pharmaceu', ticker: 'RARE.US' },
            { icono: 'ios-star-outline', nombre: 'Alpha Metallurgical', ticker: 'AMR.US' },
            { icono: 'ios-star-outline', nombre: 'Altium Limited', ticker: 'ALU.US' },
            { icono: 'ios-star-outline', nombre: 'Ambrx Biopharm', ticker: 'AMAM.US' },
            { icono: 'ios-star-outline', nombre: 'Asp Isotopes', ticker: 'ASPI.US' },
            // BBBBBBBBBBBBBBBBBB
            ...
            { icono: 'ios-star-outline', nombre: 'Blucora', ticker: 'BCOR.US' },
            ...
            { icono: 'ios-star-outline', nombre: 'Avexis', ticker: 'AVXS.US' },
            { icono: 'ios-star-outline', nombre: 'Beigene', ticker: 'BGNE.US' },
            { icono: 'ios-star-outline', nombre: 'Blueprint Medicines', ticker: 'BPMC.US' },
            { icono: 'ios-star-outline', nombre: 'Caredx', ticker: 'CDNA.US' },
            { icono: 'ios-star-outline', nombre: 'Chegg Inc.', ticker: 'CHGG.US' },
            { icono: 'ios-star-outline', nombre: 'Stamps.com', ticker: 'STMP.US' },
            { icono: 'ios-star-outline', nombre: 'Biontech Se.', ticker: 'BNTX.US' },
            // CCCCCCCCCCCCCCCCCC
            { icono: 'ios-star-outline', nombre: 'Comfort Systems', ticker: 'FIX.US' },
            { icono: 'ios-star-outline', nombre: 'Cabaletta Bio', ticker: 'CABA.US' },
            { icono: 'ios-star-outline', nombre: 'C.H. Robinson Worldwide', ticker: 'CHRW.US' },
            { icono: 'ios-star-outline', nombre: 'C.R. Bard', ticker: 'BCR.US' },
            { icono: 'ios-star-outline', nombre: 'Transglobe Energy', ticker: 'TGA.US' },
            { icono: 'ios-star-outline', nombre: 'Catalyst Bio', ticker: 'CBIO.US' },
            ...
            { icono: 'ios-star-outline', nombre: 'Htg Molecular Dia', ticker: 'HTGM.US' },
            { icono: 'ios-star-outline', nombre: 'Cboe Global Markets', ticker: 'CBOE.US' },
            { icono: 'ios-star-outline', nombre: 'CBS', ticker: 'CBS.US' },
            { icono: 'ios-star-outline', nombre: 'Karyopharm Therapeut', ticker: 'KPTI.US' },
            ...
            { icono: 'ios-star-outline', nombre: 'Verastem', ticker: 'VSTM.US' },
            { icono: 'ios-star-outline', nombre: 'Cigna', ticker: 'CI.US' },
            { icono: 'ios-star-outline', nombre: 'Cintas', ticker: 'CTAS.US' },
            { icono: 'ios-star-outline', nombre: 'Kingtone Wirelessinf', ticker: 'KONE.US' },
            ...
            { icono: 'ios-star-outline', nombre: 'Crispr Therapeutics', ticker: 'CRSP.US' },
            { icono: 'ios-star-outline', nombre: 'E.L.F. Beauty', ticker: 'ELF.US' },
            { icono: 'ios-star-outline', nombre: 'Cypress Semiconductor', ticker: 'CY.US' },
            { icono: 'ios-star-outline', nombre: 'Mimecast', ticker: 'MIME.US' },
            { icono: 'ios-star-outline', nombre: 'Smart Global Holdings', ticker: 'SGH.US' },
            { icono: 'ios-star-outline', nombre: 'Turtle Beach Corp', ticker: 'HEAR.US' },
            { icono: 'ios-star-outline', nombre: 'Ptc Therapeutics', ticker: 'PTCT.US' },
            { icono: 'ios-star-outline', nombre: 'Consol Energy', ticker: 'CEIX.US' },
            { icono: 'ios-star-outline', nombre: 'Crowstrikes Holdings', ticker: 'CRWD.US' },
            { icono: 'ios-star-outline', nombre: 'Chesapeake Energy', ticker: 'CHKEZ.US' },
            { icono: 'ios-star-outline', nombre: 'Constellation Energy', ticker: 'CEG.US' },
            // DDDDDDDDDDDDDDDDDDDDD
            { icono: 'ios-star-outline', nombre: 'Dream Finders', ticker: 'DFH.US' },
            { icono: 'ios-star-outline', nombre: 'Dianthus Therapeutics', ticker: 'DNTH.US' },
            { icono: 'ios-star-outline', nombre: 'D.R. Horton', ticker: 'DHI.US' },
            { icono: 'ios-star-outline', nombre: 'Okta', ticker: 'OKTA.US' },
            ...
            { icono: 'ios-star-outline', nombre: 'Aptose Bioscns', ticker: 'APTO.US' },
            ...
            { icono: 'ios-star-outline', nombre: 'Rafael Holdings', ticker: 'RFL.US' },
            { icono: 'ios-star-outline', nombre: 'Dxc Technology Company', ticker: 'DXC.US' },
            { icono: 'ios-star-outline', nombre: 'Tactile Systems Technology', ticker: 'TCMD.US' },
            { icono: 'ios-star-outline', nombre: 'Anaptysbio Inc.', ticker: 'ANAB.US' },
            { icono: 'ios-star-outline', nombre: 'Axogen', ticker: 'AXGN.US' },
            { icono: 'ios-star-outline', nombre: 'Xoxo Group', ticker: 'XOXO.US' },
            { icono: 'ios-star-outline', nombre: 'Liveperson', ticker: 'LPSN.US' },
            { icono: 'ios-star-outline', nombre: 'Five9 Inc.', ticker: 'FIVN.US' },
            { icono: 'ios-star-outline', nombre: 'Galectin Therapeutic', ticker: 'GALT.US' },
            { icono: 'ios-star-outline', nombre: 'Ingevity Corp.', ticker: 'NGVT.US' },
            { icono: 'ios-star-outline', nombre: 'The Trade Desk', ticker: 'TTD.US' },
            { icono: 'ios-star-outline', nombre: 'Loxo Oncology', ticker: 'LOXO.US' },
            { icono: 'ios-star-outline', nombre: 'Madrigal Pharmaceuticals', ticker: 'MDGL.US' },
            { icono: 'ios-star-outline', nombre: 'MGP Ingredients', ticker: 'MGPI.US' },
            { icono: 'ios-star-outline', nombre: 'Ringcentral', ticker: 'RNG.US' },
            { icono: 'ios-star-outline', nombre: 'Copart', ticker: 'CPRT.US' },
            { icono: 'ios-star-outline', nombre: 'Iqiyi Inc.', ticker: 'IQ.US' },
            { icono: 'ios-star-outline', nombre: 'PTC', ticker: 'PTC.US' },
            { icono: 'ios-star-outline', nombre: 'Shutterfly', ticker: 'SFLY.US' },
            { icono: 'ios-star-outline', nombre: 'Tandem Diabetes Care', ticker: 'TNDM.US' },
            { icono: 'ios-star-outline', nombre: 'NII Holdings', ticker: 'NIHD.US' },
            { icono: 'ios-star-outline', nombre: 'Intelsat S.A.', ticker: 'I.US' },
            { icono: 'ios-star-outline', nombre: 'Bluelinx Holdings', ticker: 'BXC.US' },
            { icono: 'ios-star-outline', nombre: 'NF Energy Saving Cor', ticker: 'NFEC.US' },
            { icono: 'ios-star-outline', nombre: 'Legacy Reserves LP', ticker: 'LGCY.US' },
            { icono: 'ios-star-outline', nombre: 'Fossil Group', ticker: 'FOSL.US' },
            { icono: 'ios-star-outline', nombre: 'Vaalco Energy', ticker: 'EGY.US' },
            { icono: 'ios-star-outline', nombre: 'Whiting Petroleum', ticker: 'WLL.US' },
            { icono: 'ios-star-outline', nombre: 'Arqule', ticker: 'ARQL.US' },
            { icono: 'ios-star-outline', nombre: 'Endocyte', ticker: 'ECYT.US' },
            { icono: 'ios-star-outline', nombre: 'Sesen Bio', ticker: 'SESN.US' },
            { icono: 'ios-star-outline', nombre: 'Arrowhead Pharma', ticker: 'ARWR.US' },
            { icono: 'ios-star-outline', nombre: 'Nucana', ticker: 'NCNA.US' },
            { icono: 'ios-star-outline', nombre: 'Techtarget', ticker: 'TTGT.US' },
            { icono: 'ios-star-outline', nombre: 'Travelzoo', ticker: 'TZOO.US' },
            { icono: 'ios-star-outline', nombre: 'Chinanet Online', ticker: 'CNET.US' },
            { icono: 'ios-star-outline', nombre: 'Shotspotter', ticker: 'SSTI.US' },
            { icono: 'ios-star-outline', nombre: 'Nuvectra', ticker: 'NVTR.US' },
            { icono: 'ios-star-outline', nombre: 'Skyline', ticker: 'SKY.US' },
            { icono: 'ios-star-outline', nombre: 'Egain', ticker: 'EGAN.US' },
            { icono: 'ios-star-outline', nombre: 'Xencor', ticker: 'XNCR.US' },
            { icono: 'ios-star-outline', nombre: 'Stein Mart', ticker: 'SMRT.US' },
            { icono: 'ios-star-outline', nombre: 'Mirati Therapeutics', ticker: 'MRTX.US' },
            { icono: 'ios-star-outline', nombre: 'Atara Biotherap', ticker: 'ATRA.US' },
            { icono: 'ios-star-outline', nombre: 'Axon', ticker: 'AAXN.US' },
            { icono: 'ios-star-outline', nombre: 'Twilio', ticker: 'TWLO.US' },
            { icono: 'ios-star-outline', nombre: 'Comstock Hldgs', ticker: 'CHCI.US' },
            { icono: 'ios-star-outline', nombre: 'Tenet Healthcare', ticker: 'THC.US' },
            { icono: 'ios-star-outline', nombre: 'Viking Thera', ticker: 'VKTX.US' },
            { icono: 'ios-star-outline', nombre: 'Casi Phrmactcls', ticker: 'CASI.US' },
            { icono: 'ios-star-outline', nombre: 'Odyssey Marine', ticker: 'OMEX.US' },
            { icono: 'ios-star-outline', nombre: 'Mei Pharma', ticker: 'MEIP.US' },
            { icono: 'ios-star-outline', nombre: 'Zymeworks', ticker: 'ZYME.US' },
            { icono: 'ios-star-outline', nombre: 'RF Industries', ticker: 'RFIL.US' },
            { icono: 'ios-star-outline', nombre: 'Enova International', ticker: 'ENVA.US' },
            { icono: 'ios-star-outline', nombre: 'Profire Energy', ticker: 'PFIE.US' },
            { icono: 'ios-star-outline', nombre: 'Immersion', ticker: 'IMMR.US' },
            { icono: 'ios-star-outline', nombre: 'Tapimmune', ticker: 'TPIV.US' },
            { icono: 'ios-star-outline', nombre: 'T2 Biosystems', ticker: 'TTOO.US' },
            { icono: 'ios-star-outline', nombre: 'Durect', ticker: 'DRRX.US' },
            { icono: 'ios-star-outline', nombre: 'Pfenex', ticker: 'PFNX.US' },
            { icono: 'ios-star-outline', nombre: 'Medifast', ticker: 'MED.US' },
            { icono: 'ios-star-outline', nombre: 'Penn Va', ticker: 'PVAC.US' },
            { icono: 'ios-star-outline', nombre: 'Penumbra', ticker: 'PEN.US' },
            { icono: 'ios-star-outline', nombre: 'Town Sports Internat', ticker: 'CLUB.US' },
            { icono: 'ios-star-outline', nombre: 'Rocket Pharmaceuticals', ticker: 'RCKT.US' },
            { icono: 'ios-star-outline', nombre: 'World Wrestling Entertainment', ticker: 'WWE.US' },
            { icono: 'ios-star-outline', nombre: 'Denbury Resources', ticker: 'DNR.US' },
            // EEEEEEEEEEEEEEEEEEEEEE 
            { icono: 'ios-star-outline', nombre: 'Freshpet', ticker: 'FRPT.US' },
            { icono: 'ios-star-outline', nombre: 'Etsy', ticker: 'ETSY.US' },
            { icono: 'ios-star-outline', nombre: 'Eaton', ticker: 'ETN.US' },
            { icono: 'ios-star-outline', nombre: 'Everbridge', ticker: 'EVBG.US' },
            { icono: 'ios-star-outline', nombre: 'Staar Surgical', ticker: 'STAA.US' },
            { icono: 'ios-star-outline', nombre: 'Euro Tech Hldg', ticker: 'CLWT.US' },
            { icono: 'ios-star-outline', nombre: 'Juniper Pharm', ticker: 'JNP.US' },
            { icono: 'ios-star-outline', nombre: 'Vince Holding', ticker: 'VNCE.US' },
            { icono: 'ios-star-outline', nombre: 'Chemocentryx', ticker: 'CCXI.US' },
            { icono: 'ios-star-outline', nombre: 'Vicor', ticker: 'VICR.US' },
            { icono: 'ios-star-outline', nombre: 'China Hgs Real Est', ticker: 'HGSH.US' },
            { icono: 'ios-star-outline', nombre: 'Pain Therapeutics', ticker: 'PTIE.US' },
            { icono: 'ios-star-outline', nombre: 'Genesis Healthcare', ticker: 'GEN.US' },
            { icono: 'ios-star-outline', nombre: 'Ebay', ticker: 'EBAY.US' },
            { icono: 'ios-star-outline', nombre: 'Greentree Hospitality Group', ticker: 'GHG.US' },
            { icono: 'ios-star-outline', nombre: 'Ascendis Pharma', ticker: 'ASND.US' },
            { icono: 'ios-star-outline', nombre: 'Coupa Software', ticker: 'COUP.US' },
            { icono: 'ios-star-outline', nombre: 'Ecolab', ticker: 'ECL.US' },
            { icono: 'ios-star-outline', nombre: 'Mammoth Energy Services', ticker: 'TUSK.US' },
            { icono: 'ios-star-outline', nombre: 'Weight Watchers International', ticker: 'WTW.US' },
            { icono: 'ios-star-outline', nombre: 'Ascena Retail', ticker: 'ASNA.US' },
            { icono: 'ios-star-outline', nombre: 'Eyepoint Pharmaceuticals', ticker: 'EYPT.US' },
            { icono: 'ios-star-outline', nombre: 'Fte Networks', ticker: 'FTNW.US' },
            { icono: 'ios-star-outline', nombre: 'Reeds', ticker: 'REED.US' },
            { icono: 'ios-star-outline', nombre: 'Edison International', ticker: 'EIX.US' },
            { icono: 'ios-star-outline', nombre: 'Vericel', ticker: 'VCEL.US' },
            { icono: 'ios-star-outline', nombre: 'Acelrx Pharmaceutica', ticker: 'ACRX.US' },
            { icono: 'ios-star-outline', nombre: 'Adaptimmune Ther Ads', ticker: 'ADAP.US' },
            { icono: 'ios-star-outline', nombre: 'Cerus', ticker: 'CERS.US' },
            { icono: 'ios-star-outline', nombre: 'Fireman B.V.', ticker: 'IFRX.US' },
            { icono: 'ios-star-outline', nombre: 'Hailiang Edu Grp Ads', ticker: 'HLG.US' },
            { icono: 'ios-star-outline', nombre: 'Arcadia Bio', ticker: 'RKDA.US' },
            { icono: 'ios-star-outline', nombre: 'Carvana', ticker: 'CVNA.US' },
            { icono: 'ios-star-outline', nombre: 'Carver Bancorp', ticker: 'CARV.US' },
            { icono: 'ios-star-outline', nombre: 'Edwards Lifesciences', ticker: 'EW.US' },
            { icono: 'ios-star-outline', nombre: 'Cti Biopharm', ticker: 'CTIC.US' },
            { icono: 'ios-star-outline', nombre: 'Regenxbio', ticker: 'RGNX.US' },
            { icono: 'ios-star-outline', nombre: 'Amer Superconductor', ticker: 'AMSC.US' },
            { icono: 'ios-star-outline', nombre: 'Electronic Arts', ticker: 'EA.US' },
            { icono: 'ios-star-outline', nombre: 'Nanostring Tech', ticker: 'NSTG.US' },
            { icono: 'ios-star-outline', nombre: 'Atlassian Corp.', ticker: 'TEAM.US' },
            { icono: 'ios-star-outline', nombre: 'Intricon', ticker: 'IIN.US' },
            { icono: 'ios-star-outline', nombre: 'Dynamic Materials', ticker: 'BOOM.US' },
            { icono: 'ios-star-outline', nombre: 'Funko', ticker: 'FNKO.US' },
            { icono: 'ios-star-outline', nombre: 'Sailpoint Technologies', ticker: 'SAIL.US' },
            { icono: 'ios-star-outline', nombre: 'Xenon Pharmace', ticker: 'XENE.US' },
            { icono: 'ios-star-outline', nombre: 'Catasys', ticker: 'CATS.US' },
            { icono: 'ios-star-outline', nombre: 'The Container Store Group', ticker: 'TCS.US' },
            { icono: 'ios-star-outline', nombre: 'Acm Research', ticker: 'ACMR.US' },
            { icono: 'ios-star-outline', nombre: 'Momenta Pharma', ticker: 'MNTA.US' },
            { icono: 'ios-star-outline', nombre: 'Proqr Therapeutics', ticker: 'PRQR.US' },
            { icono: 'ios-star-outline', nombre: 'Genprex', ticker: 'GNPX.US' },
            { icono: 'ios-star-outline', nombre: 'Myovant Sciences', ticker: 'MYOV.US' },
            { icono: 'ios-star-outline', nombre: '500Wan.Com', ticker: 'WBAI.US' },
            { icono: 'ios-star-outline', nombre: 'Codexis', ticker: 'CDXS.US' },
            { icono: 'ios-star-outline', nombre: 'Geopark Hldgs', ticker: 'GPRK.US' },
            { icono: 'ios-star-outline', nombre: 'Ceragon Networks', ticker: 'CRNT.US' },
            { icono: 'ios-star-outline', nombre: 'Transenterix', ticker: 'TRXC.US' },
            { icono: 'ios-star-outline', nombre: 'Seacor Marine Holdings', ticker: 'SMHI.US' },
            { icono: 'ios-star-outline', nombre: 'Enphase Energy', ticker: 'ENPH.US' },
            { icono: 'ios-star-outline', nombre: 'New Relic', ticker: 'NEWR.US' },
            { icono: 'ios-star-outline', nombre: 'Ubiquiti Networks', ticker: 'UBNT.US' },
            { icono: 'ios-star-outline', nombre: 'Coherus Bio', ticker: 'CHRS.US' },
            { icono: 'ios-star-outline', nombre: 'Enanta Pharmaceutica', ticker: 'ENTA.US' },
            { icono: 'ios-star-outline', nombre: 'Mongodb', ticker: 'MDB.US' },
            { icono: 'ios-star-outline', nombre: 'Eloxx Pharmaceuticals', ticker: 'ELOX.US' },
            { icono: 'ios-star-outline', nombre: 'Adverum Biotechnlgs', ticker: 'ADVM.US' },
            { icono: 'ios-star-outline', nombre: 'Evolus', ticker: 'EOLS.US' },
            { icono: 'ios-star-outline', nombre: 'Workiva', ticker: 'WK.US' },
            { icono: 'ios-star-outline', nombre: 'Biolife Solutions', ticker: 'BLFS.US' },
            { icono: 'ios-star-outline', nombre: 'Pioneer Energy Services', ticker: 'PES.US' },
            { icono: 'ios-star-outline', nombre: 'American Pub.', ticker: 'APEI.US' },
            { icono: 'ios-star-outline', nombre: 'Sorrento Therpt', ticker: 'SRNE.US' },
            { icono: 'ios-star-outline', nombre: 'Surmodics', ticker: 'SRDX.US' },
            { icono: 'ios-star-outline', nombre: 'Healthequity', ticker: 'HQY.US' },
            { icono: 'ios-star-outline', nombre: 'W&T Offshore', ticker: 'WTI.US' },
            { icono: 'ios-star-outline', nombre: 'Bandwidth', ticker: 'BAND.US' },
            { icono: 'ios-star-outline', nombre: 'R1 Rcm', ticker: 'RCM.US' },
            { icono: 'ios-star-outline', nombre: 'Match Group', ticker: 'MTCH.US' },
            { icono: 'ios-star-outline', nombre: 'Wix.Com', ticker: 'WIX.US' },
            { icono: 'ios-star-outline', nombre: 'Aslan Pharmaceuticals', ticker: 'ASLN.US' },
            { icono: 'ios-star-outline', nombre: 'California Resources', ticker: 'CRC.US' },
            { icono: 'ios-star-outline', nombre: 'Intelligent Systems', ticker: 'INS.US' },
            { icono: 'ios-star-outline', nombre: 'Geron', ticker: 'GERN.US' },
            { icono: 'ios-star-outline', nombre: 'Eastside Distilling', ticker: 'EAST.US' },
            { icono: 'ios-star-outline', nombre: 'Sunrun', ticker: 'RUN.US' },
            { icono: 'ios-star-outline', nombre: 'Fate Therapeutics', ticker: 'FATE.US' },
            { icono: 'ios-star-outline', nombre: 'Ollie S Bargain', ticker: 'OLLI.US' },
            { icono: 'ios-star-outline', nombre: 'Innovate Biopharmaceuticals', ticker: 'INNT.US' },
            { icono: 'ios-star-outline', nombre: 'Exp Realty Internati', ticker: 'EXPI.US' },
            { icono: 'ios-star-outline', nombre: 'Exp Realty Internati', ticker: 'NDLS.US' },
            { icono: 'ios-star-outline', nombre: 'Aeglea Biothera', ticker: 'AGLE.US' },
            { icono: 'ios-star-outline', nombre: 'Cytosorbents Cor', ticker: 'CTSO.US' },
            { icono: 'ios-star-outline', nombre: 'Innovative Industrial', ticker: 'IIPR.US' },
            { icono: 'ios-star-outline', nombre: 'Rapid7', ticker: 'RPD.US' },
            { icono: 'ios-star-outline', nombre: 'Uniqure N.V.', ticker: 'QURE.US' },
            { icono: 'ios-star-outline', nombre: 'Evolent Health', ticker: 'EVH.US' },
            { icono: 'ios-star-outline', nombre: 'Planet Fitness', ticker: 'PLNT.US' },
            { icono: 'ios-star-outline', nombre: 'Tabula Rasa Healthcare', ticker: 'TRHC.US' },
            { icono: 'ios-star-outline', nombre: 'Eli Lilly', ticker: 'LLY.US' }, { icono: 'ios-star-outline', nombre: 'Emerson Electric', ticker: 'EMR.US' },
            ...
            { icono: 'ios-star-outline', nombre: 'ETrade Financial', ticker: 'ETFC.US' }, { icono: 'ios-star-outline', nombre: 'Eldorado Resorts', ticker: 'ERI.US' },
            { icono: 'ios-star-outline', nombre: 'GDS Holdings', ticker: 'GDS.US' }, { icono: 'ios-star-outline', nombre: 'Inogen', ticker: 'INGN.US' },
            ...
            { icono: 'ios-star-outline', nombre: 'Goodyear Tire Rubber', ticker: 'GT.US' }, { icono: 'ios-star-outline', nombre: 'Grubhub Inc.', ticker: 'GRUB.US' },
            ...
            { icono: 'ios-star-outline', nombre: 'Helia Group', ticker: 'HLI.US' }, { icono: 'ios-star-outline', nombre: 'H&R Block', ticker: 'HRB.US' },
            ...
            { icono: 'ios-star-outline', nombre: 'Lumentum Holdings', ticker: 'LITE.US' }, { icono: 'ios-star-outline', nombre: 'Trupanion', ticker: 'TRUP.US' },
            // MMMMMMMMMMMMMMMMMMMMMM
            { icono: 'ios-star-outline', nombre: 'Direxion Daily', ticker: 'MSFU.US' }, { icono: 'ios-star-outline', nombre: 'Meta Platforms', ticker: 'META.US' },
            ...
            { icono: 'ios-star-outline', nombre: 'Novanta', ticker: 'NOVT.US' }, { icono: 'ios-star-outline', nombre: 'Transunion', ticker: 'TRU.US' },
            ...
            { icono: 'ios-star-outline', nombre: 'Roper Industries', ticker: 'ROP.US' }, { icono: 'ios-star-outline', nombre: 'Solaredge Technologies', ticker: 'SEDG.US' },
            // SSSSSSSSSSSSSSSSSSSSS
            { icono: 'ios-star-outline', nombre: 'Global Semiconductor', ticker: 'SEMI.US' },
            ...
            // TTTTTT
            { icono: 'ios-star-outline', nombre: 'Temple & Webster', ticker: 'TPW.US' },
            ...
            { icono: 'ios-star-outline', nombre: '2U Inc.', ticker: 'TWOU.US' }, { icono: 'ios-star-outline', nombre: 'Tal Education Group', ticker: 'TAL.US' },
            { icono: 'ios-star-outline', nombre: 'Topbuild Corp.', ticker: 'BLD.US' }, { icono: 'ios-star-outline', nombre: 'Centene', ticker: 'CNC.US' },
            { icono: 'ios-star-outline', nombre: 'Atlassian Corp.', ticker: 'TEAM.US' }, { icono: 'ios-star-outline', nombre: 'Total System Services', ticker: 'TSS.US' },
            { icono: 'ios-star-outline', nombre: 'Vista Energy', ticker: 'VIST.US' },
            // UUUUUU
        ...
        this.mercadoCrypto = [
            { icono: 'ios-star-outline', nombre: 'Cardano', ticker: 'ADA-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'AdEx', ticker: 'ADX-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Aeternity', ticker: 'AE-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Aragon', ticker: 'ANT-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Ardor', ticker: 'ARDR-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'ARK', ticker: 'ARK-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'ATB coin', ticker: 'ATB-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Autumncoin', ticker: 'ATM-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Basic Attention Token', ticker: 'BAT-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'BitConnect Coin', ticker: 'BCCOIN-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Bitcoin Cash / BCC', ticker: 'BCH-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'ByteCoin', ticker: 'BCN-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'BlockNet', ticker: 'BLOCK-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Binance Coin', ticker: 'BNB-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Bancor Network Token', ticker: 'BNT-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Bitquence', ticker: 'BQX-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'BitcoinDark', ticker: 'BTCD-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Bitcoin', ticker: 'BTC-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Bitcoin Gold', ticker: 'BTG-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'BTM', ticker: 'BTM-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Bitshares', ticker: 'BTS-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Civic', ticker: 'CVC-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'DigitalCash', ticker: 'DASH-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Dentacoin', ticker: 'DCN-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Decred', ticker: 'DCR-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'DigiByte', ticker: 'DGB-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Digix DAO', ticker: 'DGD-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'district0x', ticker: 'DNT-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Dogecoin', ticker: 'DOGE-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Edgeless', ticker: 'EDG-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'EOS', ticker: 'EOS-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Ethereum Classic', ticker: 'ETC-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Ethereum', ticker: 'ETH-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Metaverse', ticker: 'ETP-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'FairCoin', ticker: 'FAIR-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Factoids', ticker: 'FCT-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'FirstCoin', ticker: 'FRST-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'FunFair', ticker: 'FUN-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Gamecredits', ticker: 'GAME-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Gas', ticker: 'GAS-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Byteball', ticker: 'GBYTE-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Gnosis', ticker: 'GNO-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Golem Network Token', ticker: 'GNT-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Hshare', ticker: 'HSR-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Iconomi', ticker: 'ICN-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'ICON Project', ticker: 'ICX-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'IOCoin', ticker: 'IOC-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'IOTA', ticker: 'IOT-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Kin', ticker: 'KIN-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Komodo', ticker: 'KMD-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Kyber Network', ticker: 'KNC-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'ChainLink', ticker: 'LINK-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Lykke', ticker: 'LKK-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Loopring', ticker: 'LRC-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Lisk', ticker: 'LSK-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Litecoin', ticker: 'LTC-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'MaidSafe Coin', ticker: 'MAID-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'MCAP', ticker: 'MCAP-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Monaco', ticker: 'MCO-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'MobileGo', ticker: 'MGO-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Melon', ticker: 'MLN-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'MonaCoin', ticker: 'MONA-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Metal', ticker: 'MTL-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'NavCoin', ticker: 'NAV-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Neblio', ticker: 'NEBL-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'NEO', ticker: 'NEO-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'NoLimitCoin', ticker: 'NLC2-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Nexus', ticker: 'NXS-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Nxt', ticker: 'NXT-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'OmiseGo', ticker: 'OMG-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Particl', ticker: 'PART-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'TenX', ticker: 'PAY-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Private Instant Verified Transaction', ticker: 'PIVX-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Populous', ticker: 'PPT-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Quoine Liquid', ticker: 'QASH-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Quantum Resistant Ledger', ticker: 'QRL-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'QTUM', ticker: 'QTUM-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Augur', ticker: 'REP-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'iExec', ticker: 'RLC-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Salt Lending', ticker: 'SALT-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Siacoin', ticker: 'SC-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'SmartCash', ticker: 'SMART-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'SingularDTV', ticker: 'SNGLS-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'SONM', ticker: 'SNM-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Status Network Token', ticker: 'SNT-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Steem', ticker: 'STEEM-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Storj', ticker: 'STORJ-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Stratis', ticker: 'STRAT-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Substratum Network', ticker: 'SUB-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'SysCoin', ticker: 'SYS-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Token as a Service', ticker: 'TAAS-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Tronix', ticker: 'TRX-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Ubiq', ticker: 'UBQ-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Tether', ticker: 'USDT-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Vechain', ticker: 'VEN-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Veritaseum', ticker: 'VERI-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'VertCoin', ticker: 'VTC-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Waves', ticker: 'WAVES-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Wings DAO', ticker: 'WINGS-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Waltonchain', ticker: 'WTC-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'CounterParty', ticker: 'XCP-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'NEM', ticker: 'XEM-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Stellar', ticker: 'XLM-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Monero', ticker: 'XMR-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'RaiBlocks', ticker: 'XRB-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Ripple', ticker: 'XRP-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Exchange Union', ticker: 'XUC-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'Verge', ticker: 'XVG-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'ZCoin', ticker: 'XZC-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'ZCash', ticker: 'ZEC-USD.CC' },
            { icono: 'ios-star-outline', nombre: 'ZenCash', ticker: 'ZEN-USD.CC' },
            { icono: 'ios-star-outline', nombre: '0x', ticker: 'ZRX-USD.CC' },
        ];
    ...
    ApiRobot.prototype.ngOnInit = function () {
        ...
        // ----------------- Top Mundo ---------------------
        this.crypto();
        this.sleep(350000).then(function () {
            _this
                ._favoritoService
                .deletePais('topmundo')
                .subscribe(function (result) {
            ...
            _this.sleep(1410000).then(function () {
                _this.australia();
            });
            _this.sleep(2220000).then(function () {
                _this.alemania();
            });
            _this.sleep(3420000).then(function () {
                _this.canada();
            });
            _this.sleep(4680000).then(function () {
                _this.italia();
            });
            _this.sleep(5980000).then(function () {
                _this.francia();
            });
            _this.sleep(6380000).then(function () {
                _this.austria();
            });
            _this.sleep(6880000).then(function () {
                _this.belgica();
            });
            _this.sleep(7200000).then(function () {
                _this.suecia();
            });
            _this.sleep(8200000).then(function () {
                _this.suiza();
            });
            _this.sleep(9390000).then(function () {
                _this.uk();
            });
            _this.sleep(10820000).then(function () {
                _this.mexico();
            });
            _this.sleep(12570000).then(function () {
                _this.portugal();
            });
            _this.sleep(12690000).then(function () {
                _this.holanda();
            });
            _this.sleep(13390000).then(function () {
                _this.noruega();
            });
            _this.sleep(14000000).then(function () {
                _this.rusia();
            });
            _this.sleep(14910000).then(function () {
                _this.brasil();
            });
            _this.sleep(15510000).then(function () {
                _this.dinamarca();
            });
            _this.sleep(16610000).then(function () {
                _this.china();
            });
            _this.sleep(17910000).then(function () {
                _this.india();
            });
        ...
        this._servicio1.getModelos('AU').subscribe(function (result) {
            ...
            _this.sleep(520000).then(function () {
                var _loop_2 = function (stock) {
                    ...
                    _this.sleep(650000).then(function () {
    ...
    ApiRobot.prototype.japon = function () {
        var _this = this;
        ...
        this._servicio1.getModelos('TSE').subscribe(function (result) {
            _this.recopilarDatos(result, _this.arrayJapon);
            _this.sleep(520000).then(function () {
                var _loop_3 = function (stock) {
                    _this.mensual(stock.ticker, _this.arrayJapon, 'Japon');
                    _this.sleep(190000).then(function () {
                        _this.semestral(stock.ticker, _this.arrayJapon, 'Japon');
                    });
                    _this.sleep(370000).then(function () {
                        _this.anual(stock.ticker, _this.arrayJapon, 'Japon');
                    });
                    _this.sleep(650000).then(function () {
                        _this._favoritoService.addPais(stock, 'japon').subscribe(function (response) {
                            if (!response) {
                                console.log('error al recibir confirmacion de guardado');
                            }
                            else {
                                console.log('Información de Japon agregada a base de datos');
                                _this.contadorJapon = _this.contadorJapon + 1;
                            }
                        }, function (error) {
                            console.log('Error al guardar datos');
                        });
                ...
                for (var _i = 0, _a = _this.arrayJapon; _i < _a.length; _i++) {
                    var stock = _a[_i];
                    _loop_3(stock);
                }
            });
            console.log(_this.arrayJapon);
            if (!_this.modelos) {
                console.log('Error en la petición de datos de este mercado');
            }
        }, function (error) {
        ...
        this._servicio1.getModelos('XETRA').subscribe(function (result) {
            ...
            _this.sleep(270000).then(function () {
                var _loop_5 = function (stock) {
                    ...
                    _this.sleep(790000).then(function () {
                        _this._favoritoService.addPais(stock, 'alemania').subscribe(function (response) {
                            if (!response) {
                                console.log('error al recibir confirmacion de guardado');
                            }
        ...
        this._servicio1.getModelos('BR').subscribe(function (result) {
            ...
            _this.sleep(35000).then(function () {
                var _loop_8 = function (stock) {
                    ...
                    _this.sleep(175000).then(function () {
    ...
    ApiRobot.prototype.suecia = function () {
        var _this = this;
        ...
        this._servicio1.getModelos('ST').subscribe(function (result) {
            _this.recopilarDatos(result, _this.arraySuecia);
            _this.sleep(300000).then(function () {
                var _loop_9 = function (stock) {
                    _this.mensual(stock.ticker, _this.arraySuecia, 'Suecia');
                    _this.sleep(225000).then(function () {
                        _this.semestral(stock.ticker, _this.arraySuecia, 'Suecia');
                    });
                    _this.sleep(425000).then(function () {
                        _this.anual(stock.ticker, _this.arraySuecia, 'Suecia');
                    });
                    _this.sleep(600000).then(function () {
                        _this._favoritoService.addPais(stock, 'suecia').subscribe(function (response) {
                            if (!response) {
                                ...
                                _this.contadorSuecia = _this.contadorSuecia + 1;
                            }
                        }, function (error) {
                            console.log('Error al guardar datos');
                        });
                ...
                for (var _i = 0, _a = _this.arraySuecia; _i < _a.length; _i++) {
                    var stock = _a[_i];
                    _loop_9(stock);
                }
            });
            console.log(_this.arraySuecia);
            if (!_this.modelos) {
                console.log('Error en la petición de datos de este mercado');
            }
        }, function (error) {
    ...
    ApiRobot.prototype.suiza = function () {
        var _this = this;
        ...
        this._servicio1.getModelos('SW').subscribe(function (result) {
            _this.recopilarDatos(result, _this.arraySuiza);
            _this.sleep(350000).then(function () {
                var _loop_10 = function (stock) {
                    _this.mensual(stock.ticker, _this.arraySuiza, 'Suiza');
                    _this.sleep(230000).then(function () {
                        _this.semestral(stock.ticker, _this.arraySuiza, 'Suiza');
                    });
                    _this.sleep(430000).then(function () {
                        _this.anual(stock.ticker, _this.arraySuiza, 'Suiza');
                    });
                    _this.sleep(650000).then(function () {
                        _this._favoritoService.addPais(stock, 'suiza').subscribe(function (response) {
                            if (!response) {
                                ...
                                _this.contadorSuiza = _this.contadorSuiza + 1;
                            }
                        }, function (error) {
                            console.log('Error al guardar datos');
                        });
                ...
                for (var _i = 0, _a = _this.arraySuiza; _i < _a.length; _i++) {
                    var stock = _a[_i];
                    _loop_10(stock);
                }
            });
            console.log(_this.arraySuiza);
            if (!_this.modelos) {
                console.log('Error en la petición de datos de este mercado');
            }
        }, function (error) {
    ...
    ApiRobot.prototype.uk = function () {
        var _this = this;
        this.contadorUk = 0;
        this
            ._favoritoService
        ...
        this._servicio1.getModelos('LSE').subscribe(function (result) {
            _this.recopilarDatos(result, _this.arrayUk);
            _this.sleep(400000).then(function () {
                var _loop_11 = function (stock) {
                    _this.mensual(stock.ticker, _this.arrayUk, 'UK');
                    _this.sleep(320000).then(function () {
                        _this.semestral(stock.ticker, _this.arrayUk, 'UK');
                    });
                    _this.sleep(620000).then(function () {
                        _this.anual(stock.ticker, _this.arrayUk, 'UK');
                    });
                    _this.sleep(920000).then(function () {
                        _this._favoritoService.addPais(stock, 'uk').subscribe(function (response) {
                            if (!response) {
                                ...
                                _this.contadorUk = _this.contadorUk + 1;
                            }
                        }, function (error) {
                            console.log('Error al guardar datos');
                        });
                ...
                for (var _i = 0, _a = _this.arrayUk; _i < _a.length; _i++) {
                    var stock = _a[_i];
                    _loop_11(stock);
                }
            });
            console.log(_this.arrayUk);
            if (!_this.modelos) {
                console.log('Error en la petición de datos de este mercado');
            }
        }, function (error) {
        ...
        this._servicio1.getModelos('MX').subscribe(function (result) {
            ...
            _this.sleep(400000).then(function () {
                var _loop_12 = function (stock) {
                    ...
                    _this.sleep(990000).then(function () {
        ...
        this._servicio1.getModelos('LS').subscribe(function (result) {
            ...
            _this.sleep(20000).then(function () {
                var _loop_13 = function (stock) {
                    ...
                    _this.sleep(85000).then(function () {
        ...
        this._servicio1.getModelos('AS').subscribe(function (result) {
            ...
            _this.sleep(120000).then(function () {
                var _loop_14 = function (stock) {
                    ...
                    _this.sleep(530000).then(function () {
        ...
        this._servicio1.getModelos('MI').subscribe(function (result) {
            ...
            _this.sleep(300000).then(function () {
                var _loop_15 = function (stock) {
                    ...
                    _this.sleep(900000).then(function () {
        ...
        this._servicio1.getModelos('OL').subscribe(function (result) {
            ...
            _this.sleep(100000).then(function () {
                var _loop_16 = function (stock) {
                    ...
                    _this.sleep(410000).then(function () {
        ...
        this._servicio1.getModelos('MCX').subscribe(function (result) {
            ...
            _this.sleep(200000).then(function () {
                var _loop_17 = function (stock) {
                    ...
                    _this.sleep(590000).then(function () {
        ...
        this._servicio1.getModelos('SA').subscribe(function (result) {
            ...
            _this.sleep(90000).then(function () {
                var _loop_18 = function (stock) {
                    ...
                    _this.sleep(380000).then(function () {
    ...
    ApiRobot.prototype.crypto = function () {
        ...
        var _loop_23 = function (stock) {
            this_2.valor(stock.ticker);
            this_2.sleep(80000)
                .then(function () {
            ...
            this_2.sleep(320000)
                ...
                _this
                    ._favoritoService
                    .addPais(stock, 'crypto')
                    .subscribe(function (response) {
                    if (!response) {
                        console.log('error al recibir confirmacion de guardado');
                    }
                    else {
                        console.log('Información de Crypto agregada a base de datos');
        ...
        var this_2 = this;
        // Recopilamos datos anual, semestral y mensual
        for (var _i = 0, _a = this.mercadoCrypto; _i < _a.length; _i++) {
            var stock = _a[_i];
            _loop_23(stock);
        }
    ...
    ApiRobot.prototype.anual = function (tickerRecibido, array, mercado) {
        ...
        this._servicio1.getAnual(tickerRecibido).subscribe(function (result) {
            if (!result) {
                ...
                var ayer_1 = parseFloat(result[result.length - 1].adjusted_close);
                _this.contamoss = 1;
                while (ayer_1 === 0 || ayer_1 === null || ayer_1 === undefined) {
                    _this.contamoss = _this.contamoss + 1;
                    ayer_1 = parseFloat(result[result.length - _this.contamoss].adjusted_close);
                }
                ...
                if (hoy > ayer_1) {
                    ...
                    resultado = parseInt(total);
                    var anual_1 = resultado;
                    if (anual_1 < 2000 || tickerRecibido.indexOf('.CC') != -1) {
                        var datoAnual_1 = array.find(function (p) {
                            return p.ticker === tickerRecibido;
                        });
                        datoAnual_1.anual = anual_1;
                        datoAnual_1.anualD = 'sube';
                        if (tickerRecibido.indexOf('.LS') === -1 && tickerRecibido.indexOf('.TO') === -1 && tickerRecibido.indexOf('.ST') === -1 && tickerRecibido.indexOf('USD.CC') === -1 && tickerRecibido.indexOf('.VI') === -1 && tickerRecibido.indexOf('.BR') === -1 && tickerRecibido.indexOf('.SW') === -1 && tickerRecibido.indexOf('.CO') === -1 && tickerRecibido.indexOf('.OL') === -1 && tickerRecibido.indexOf('.SHG') === -1 && tickerRecibido.indexOf('.NSE') === -1 && tickerRecibido.indexOf('.SA') === -1 && tickerRecibido.indexOf('.MX') === -1 && tickerRecibido.indexOf('.MCX') === -1) {
                            _this._servicio1.getbiAnual(tickerRecibido).subscribe(function (result) {
                                if (!result) {
                                    alert('No obtenemos resultado en el parseo BiAnual');
                                }
                                            ...
                                            _this._servicio1.getriAnual(tickerRecibido).subscribe(function (result) {
                                                if (!result) {
                                                    ...
                                                    if (hoytri > ayertri) {
                                                        ...
                                                        resultado = parseInt(total);
                                                        var triAnual = resultado;
                                                        datoAnual_1.triAnual = triAnual;
                                                        if (triAnual > 350 && triAnual >= biAnual_1 && ayertri <= ayerBi_1 && ayertri < ayer_1) {
                                                            ...
                                                            if (anual_1 > 50 && anual_1 < 450 && datoAnual_1.semestral < 330 && datoAnual_1.mensual < 80) {
                                                                var stock = { nombre: datoAnual_1.nombre, ticker: tickerRecibido, icono: 'ios-star-outline', moneda: 'EUR', valor: datoAnual_1.valor, anual: anual_1, semestral: datoAnual_1.semestral, mensual: datoAnual_1.mensual, biAnual: datoAnual_1.biAnual, triAnual: datoAnual_1.triAnual };
                                                                _this._favoritoService.addPais(stock, 'topmundo').subscribe(function (response) {
                                                                    if (!response) {
                                                                        console.log('error al recibir confirmacion de guardado');
                                                                    }
    ...
    ApiRobot.prototype.recopilarDatos = function (result, array) {
        var _loop_24 = function (stock) {
            ...
            this_3._servicio1.seleccionarMas3(ticker).subscribe(function (result) {
                if (!result) {
